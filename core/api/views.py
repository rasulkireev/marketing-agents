...
from core.utils import process_project_url, generate_blog_titles_with_claude, save_blog_titles
...
def generate_title_suggestions(request: HttpRequest, data: GenerateTitleSuggestionsIn):
    ...
    try:
        ...
        logger.error(
            "Error generating title suggestions",
            error=str(e),
            project_id=project.id
        )
